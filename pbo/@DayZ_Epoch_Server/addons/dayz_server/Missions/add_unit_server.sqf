        ...
        if (_levelnum==1) then //in_military troops
        {
            ...
            if ((x == 2) || (x == 3)) then //troops sergeant
            {
                ...
                switch (_rndLOut) do
                {
                  ...
                  case 3: {["LeeEnfield","10x_303","MakarovSD","8Rnd_9x18_Makarov"]};
                };
            };
            if (x > 3) then //troops soldiers
            {
                ...
                switch (_rndLOut) do
                {
                  case 0: {["LeeEnfield","10x_303","MakarovSD","8Rnd_9x18_Makarov"]};
                  case 1: {["M24","5Rnd_762x51_M24","MakarovSD","8Rnd_9x18_Makarov"]};
                  case 2: {["LeeEnfield","10x_303","MakarovSD","8Rnd_9x18_Makarov"]};
