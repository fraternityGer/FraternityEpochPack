...
_crate2 addWeaponCargoGlobal ["FN_FAL_ANPVS4", 1];
...
_crate2 addWeaponCargoGlobal ["NVGoggles", 1];
...
_crate2 addMagazineCargoGlobal ["ItemBriefcase50oz", 1];
...
_crate2 addMagazineCargoGlobal ["10Rnd_127x99_m107", 5];
