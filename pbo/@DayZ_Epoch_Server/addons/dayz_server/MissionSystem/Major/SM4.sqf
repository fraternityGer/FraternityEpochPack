...
sleep 5;
_aispawn = [_coords,80,6,4,1] execVM "\z\addons\dayz_server\MissionSystem\add_unit_server.sqf";//AI Guards
sleep 5;
_aispawn = [_coords,40,4,4,1] execVM "\z\addons\dayz_server\MissionSystem\add_unit_server.sqf";//AI Guards
