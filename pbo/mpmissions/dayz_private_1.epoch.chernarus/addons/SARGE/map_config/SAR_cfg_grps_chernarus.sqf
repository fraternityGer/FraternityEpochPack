...
[SAR_marker_sectorfng_back,3,0,15,"patrol",true,3600] call SAR_AI;
[SAR_marker_sectorfng_crate1,3,1,4,"fortify",true,3600] call SAR_AI;
[SAR_marker_sectorfng_crate2,3,1,4,"fortify",true,3600] call SAR_AI;
[SAR_marker_sectorfng_crate3,3,1,4,"fortify",true,3600] call SAR_AI;
[SAR_marker_sectorfng_crate4,3,1,4,"fortify",true,3600] call SAR_AI;
[SAR_marker_sectorfng_crate5,3,1,4,"fortify",true,3600] call SAR_AI;
diag_log format["SAR_AI: Static Spawning Sector FNG finished"];
