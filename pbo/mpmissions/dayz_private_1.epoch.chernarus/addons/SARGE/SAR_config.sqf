...
SAR_surv_sniper_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",2]];
...
SAR_band_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["NVGoggles",10],["Binocular_Vector",2]];
...
SAR_band_sniper_tools = [["ItemMap",50],["ItemCompass",30],["NVGoggles",50],["ItemFlashlight",100],["Binocular_Vector",10]];
